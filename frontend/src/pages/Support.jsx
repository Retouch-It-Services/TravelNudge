  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-gray-100 via-blue-100 to-purple-100 relative overflow-hidden overflow-y-auto py-6 px-4">
      ...
      <div className="relative w-full max-w-6xl my-auto">
        {/* Header Section */}
        <div className="bg-white/90 backdrop-blur-lg border-2 border-gray-300 rounded-2xl shadow-2xl overflow-hidden mb-8">
          ...
          <div className="p-8 text-center">
            ...
            <h1 className="text-3xl font-bold text-gray-800 mb-3">
              TravelNudge <span className="bg-gradient-to-r from-cyan-700 to-blue-700 bg-clip-text text-transparent">Support</span>
            </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
          {categories.map((item, index) => (
            <div
              key={index}
              className="group bg-white/90 backdrop-blur-lg border-2 border-gray-300 rounded-2xl shadow-2xl p-6 hover:shadow-xl transition-all duration-300 hover:border-cyan-500/50"
            >
              <div className="flex items-center gap-4 mb-4">
                <div className="p-3 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-xl group-hover:scale-110 transition-transform duration-300">
        ...
        {/* FAQs Section */}
        <div className="bg-white/90 backdrop-blur-lg border-2 border-gray-300 rounded-2xl shadow-2xl overflow-hidden mb-12">
          <div className="h-1 bg-gradient-to-r from-cyan-600 to-blue-600"></div>
          <div className="p-8">
            ...
            <div className="space-y-4">
              {faqs.map((f, i) => (
                <div
                  key={i}
                  className="group bg-white/80 border-2 border-gray-300 rounded-xl p-6 hover:border-cyan-500/50 transition-all duration-300"
                >
        ...
        <div className="bg-white/90 backdrop-blur-lg border-2 border-gray-300 rounded-2xl shadow-2xl overflow-hidden">
          <div className="h-1 bg-gradient-to-r from-cyan-600 to-blue-600"></div>
          <div className="p-8 text-center">
            <div className="w-12 h-12 bg-gradient-to-r from-cyan-600 to-blue-600 rounded-xl flex items-center justify-center mx-auto mb-4 shadow-lg">
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
              <a
                ...
                className="flex items-center gap-3 bg-gradient-to-r from-cyan-600 to-blue-600 text-white px-6 py-3 rounded-xl hover:from-cyan-700 hover:to-blue-700 transform hover:scale-[1.02] shadow-lg hover:shadow-cyan-600/40 transition-all duration-300 font-semibold"
              >
                <Mail className="w-5 h-5" />
                Email Support
              </a>
              <button className="flex items-center gap-3 border-2 border-cyan-600 text-cyan-700 px-6 py-3 rounded-xl hover:bg-cyan-100 transition-all duration-300 font-semibold">
        ...
        <div className="text-center mt-4">
          <Link
            to="/home"
            className="inline-flex items-center space-x-2 text-gray-600 hover:text-gray-800 transition-colors duration-200 text-sm"
          >
